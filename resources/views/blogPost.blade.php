                ...
                <div class="row g-4">
                    <div class="col-lg-12 order-2 order-lg-1">
                        <div class="blog__item blog-single__left-item shadow-none">
                            <div class="image">
                                ...
                                <span class="blog-tag">{{ $post->category->name ?? 'Uncategorized' }}</span>
                            </div>
                    ...
                    {{-- <div class="col-lg-8 order-2 order-lg-1">
                        <div class="blog__item blog-single__left-item shadow-none">
                            ...
                            <div class="blog__content p-0">
                                <h4 class="mt-20 mb-20 fs-30">
                                    Rebecca's New Album Aid for the Needy
                                </h4>
                                <ul class="pb-4 bor-bottom">
                                    <li>
                                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                            ...
                            <div class="blog-single__comment d-flex gap-4 mt-60 pb-60 bor-bottom">
                                ...
                                <div class="content">
                                    <div class="head d-flex flex-wrap gap-2 align-items-center justify-content-between">
                                        <div class="con">
                                            <h5>
                                                <a href="#0" class="primary-hover">Ralph Edwards</a>
                                            </h5>
                            ...
                            <div class="blog-single__comment d-flex gap-4 mt-60 pb-60 bor-bottom">
                                ...
                                <div class="content">
                                    <div class="head d-flex flex-wrap gap-2 align-items-center justify-content-between">
                                        <div class="con">
                                            <h5>
                                                <a href="#0" class="primary-hover">Albert Flores</a>
                                            </h5>
                                            <span>March 20, 2023 at 2:37 pm</span>
                                        </div>
                                        <div class="star">
                        ...
                        <div class="blog-single__right-item">
                            ...
                            <div class="item shadow mb-30">
                                ...
                                <ul class="single-post">
                                    <li>
                                        ...
                                        <div class="con">
                                            <h6>
                                                <a href="blog-single.html" class="primary-hover">More with elements all
                                                    for one low</a>
                                            </h6>
                                    ...
                                    <li>
                                        ...
                                        <div class="con">
                                            <h6>
                                                <a href="blog-single.html" class="primary-hover">Rebecca’s Charity Album
                                                    A Brilliant Display</a>
                                            </h6>
                                            <span>20 Nov, 2023</span>
                                        </div>
                                    </li>
                                    <li>
                                        ...
                                        <div class="con">
                                            <h6>
                                                <a href="blog-single.html" class="primary-hover">Provide Healthy Meals
                                                    to an Impoverished</a>
                                            </h6>
                                            <span>20 Nov, 2023</span>
                                        </div>
                                    </li>
                            ...
                            <div class="item shadow mb-30">
                                ...
                                <div class="tags">
                                    ...
                                    <a href="#0">Charity</a>
                                    <a href="#0">Donation</a>
                                    <a href="#0">Kids Educations</a>
                                    <a href="#0">Fundraising</a>
                                    <a href="#0">Kids Foods</a>
                                </div>
                            </div>
                        </div>
                    </div> --}}
