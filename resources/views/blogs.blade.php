                        ...
                        <div class="col-xl-4 col-md-6 wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                            <div class="blog__item">
                                ...
                                <div class="blog__content pt-4">
                                    ...
                                    <h4 class="mt-20 pb-25 bor-bottom"><a href="blog/{{ $post->id }}"
                                            class="primary-hover">{{ $post->title }}</a></h4>
                                    <a class="mt-4" href="blog/{{ $post->id }}"><span class="read-more fw-bold transition">Read
